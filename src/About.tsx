...
const About: React.FC = () => {
    return (
        <section className="bg-rose-pine-surface text-rose-pine-text py-20">
            <div className="container mx-auto px-6">
                <h2 className="text-4xl font-bold mb-6 text-rose-pine-love">About Me</h2>
                <p className="text-lg leading-relaxed mb-4 text-rose-pine-subtle">
                ...
                <p className="text-lg leading-relaxed text-rose-pine-subtle">
